...
HTML;
     ...
     */
    public static function conviteCadastroDiretorio(string $email, string $nomeEmpresa = ''): bool
    {
        $nomeExib = htmlspecialchars($nomeEmpresa, ENT_QUOTES, 'UTF-8');
        $saudacao = trim($nomeEmpresa) !== '' ? "Olá, {$nomeExib}!" : 'Olá!';
        $cfg      = require BASE_PATH . '/config/app.php';
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.06)">
        ...
        <tr><td style="padding:36px 32px 8px">
          ...
          <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#475569">
            Seu <strong>teste grátis de 7 dias</strong> já está rolando. Aproveite sem pressa. 😉
          </p>
