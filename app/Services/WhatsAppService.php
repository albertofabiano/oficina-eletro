...
class WhatsAppService
{
    ...
    public static function boasVindas(string $numero, string $nomeEmpresa): bool
    {
        ...
        $msg  = "Olá, *{$nome}*! 🎉\n\n"
              ...
              . "Seu *período grátis de 7 dias* já começou a contar. 😉\n\n"
     ...
     *  agora -- null quando a instância está conectada. Centraliza a mensagem certa pros
     *  vários pontos do sistema que checavam `statusEmpresa() !== 'open'` antes de chamar
     *  enviarTexto()/enviarDocumento(), pra não duplicar o texto em cada controller. */
