    ...
    <table class="table table-hover mb-0 align-middle" style="font-size:1rem">
      ...
      <tbody>
        ...
        <tr class="os-row <?= $atrasada ? 'table-danger' : '' ?>" style="cursor:pointer" title="Clique para ver detalhes">
          ...
          <td style="white-space:nowrap"><?php if (($os['valor_total'] ?? 0) > 0): ?><span style="color:#16a34a;font-weight:700"><?= money($os['valor_total']) ?></span><?php elseif (!empty($os['garantia_finalizada'])): ?><span style="color:#0d9488;font-weight:700"><i class="bi bi-shield-check me-1"></i>Garantia finalizada</span><?php elseif (($os['status_tipo'] ?? '') === 'entregue'): ?><span style="background:#16a34a;color:#fff;font-weight:600;padding:3px 9px;border-radius:6px;font-size:.76rem"><i class="bi bi-check-circle me-1"></i>Fechada sem Débito</span><?php else: ?><span style="color:#b45309"><i class="bi bi-hourglass-split me-1"></i>Pendente</span><?php endif; ?></td>
