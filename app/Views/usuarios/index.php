...
<div class="d-flex justify-content-end align-items-center gap-2 mb-3">
  ...
  <a href="<?= url('/planos') ?>" target="_top" class="btn btn-outline-warning fw-semibold"><i class="bi bi-arrow-up-circle me-1"></i>Fazer upgrade para adicionar mais</a>
  <?php else: ?>
  <a href="<?= url('/usuarios/novo') ?>" target="_top" class="btn btn-primary"><i class="bi bi-person-plus"></i> Novo Usuário</a>
  <?php endif; ?>
</div>
<?php if ($limiteAtingido): ?>
    ...
    <table class="table table-hover mb-0 align-middle">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-end">
            <a href="<?= url('/usuarios/' . $u['id'] . '/editar') ?>" target="_top" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil"></i></a>
