  ...
  <div class="container">
    ...
    <div class="feat-grid">
      ...
      $feats=[
        ...
        ['bi-whatsapp','rgba(37,211,102,.14)','#25d366','Fotos de entrada direto no WhatsApp',
          'Escaneia o QR, fotografa o aparelho pelo celular e as fotos chegam na hora no WhatsApp do cliente e da sua empresa — sem app, sem login, sem ficar guardado no sistema. Prova de estado de entrada, entregue na hora.', 'Novo'],
        ...
        ['bi-file-earmark-medical-fill','rgba(8,145,178,.14)','#0891b2','Documento certo pra cada status',
          'Coloque a OS em "Laudo Técnico" e o botão Imprimir já mostra o laudo formatado, pronto pra assinar. Marcou "Sem Conserto"? Sai um comunicado explicando ao cliente que não teve cobrança e que o aparelho está disponível pra retirada — sem precisar escrever nada.', 'Novo'],
        ...
        ['bi-cash-coin','rgba(34,197,94,.12)','#4ade80','Comissão de técnico',
          'Cada técnico com seu percentual. A comissão puxa sozinha o valor da OS — ou você lança na mão quando quiser. Marcou como paga? Já cai automático no Financeiro.', 'Novo'],
        ['bi-credit-card-2-front-fill','rgba(168,85,247,.12)','#c084fc','Pagamento dividido',
          'Metade no Pix, metade no cartão? Sem problema. Feche a OS ou venda no PDV misturando dinheiro, Pix, débito e crédito na mesma venda, com a taxa de cada cartão calculada e lançada sozinha.', 'Novo'],
        ['bi-search','rgba(99,102,241,.14)','#818cf8','Busca global no topo',
          'Digite o número da OS, nome do cliente ou produto na barra de cima e ache na hora — de qualquer tela, sem trocar de módulo.', 'Novo'],
        ['bi-wifi-off','rgba(20,184,166,.12)','#2dd4bf','O trabalho não para se a internet cair',
          'Sem conexão, você ainda consulta as OS do dia e cria rascunhos no navegador. Assim que a internet volta, tudo sincroniza sozinho — sem perder nada, sem retrabalho.', 'Novo'],
        ['bi-tools','rgba(13,110,253,.12)','#0d6efd','Catálogo de Serviços',
          'Cadastre os serviços que você mais presta, com um valor padrão. Na hora de lançar na OS, o campo já sugere pelo nome — menos digitação, menos descrição torta, preço padronizado.', 'Novo'],
        ['bi-piggy-bank-fill','rgba(34,197,94,.12)','#22c55e','Adiantamento de peça cara',
          'Peça cara e o cliente dá um sinal antes de você comprar? Registre o adiantamento com a mesma regra de taxa de cartão do fechamento — o valor já entra no Financeiro na hora, e no fechamento só falta cobrar a diferença.', 'Novo'],
        ['bi-credit-card-fill','rgba(168,85,247,.12)','#a855f7','Taxa de cartão também no Pix da maquininha',
          'Sua maquininha cobra até em Pix? Configure a taxa certinha pra esse canal — sem confundir com o Pix direto na conta, que continua sem taxa nenhuma.', 'Novo'],
        ['bi-speedometer2','rgba(249,115,22,.12)','#fb923c','Painel Hoje na Agenda',
          'Assim que abre a Agenda: quantas OS aguardam atendimento, orçamentos pra aprovar, atrasos, entregas previstas pra hoje e a ocupação de cada técnico — o resumo do dia antes de mexer em qualquer coisa.', 'Novo'],
        ['bi-send-check-fill','rgba(14,165,233,.12)','#0ea5e9','Agenda avisa o técnico pelo WhatsApp',
          'Vinculou a OS a uma visita, coleta ou entrega? Um clique manda pro WhatsApp do técnico o endereço, o defeito relatado e o PDF da OS. "Atendimento rápido" cria o compromisso e já avisa, tudo junto.', 'Novo'],
        ['bi-arrow-left-right','rgba(20,184,166,.12)','#2dd4bf','Financeiro e Agenda conectados',
          'Lançou uma conta a pagar ou receber? Ela aparece sozinha na Agenda na data do vencimento, com etiqueta verde ou vermelha e lembrete automático 1 dia antes. Marcou como paga de um lado, fecha dos dois — sem duplicar cadastro.', 'Novo'],
        ['bi-calendar-week','rgba(168,85,247,.12)','#c084fc','Prazo fixo de recebimento no cartão',
          'Sua adquirente paga no dia seguinte? Semanal? Escolha o prazo certo (0 a 30 dias) e o Financeiro só considera o dinheiro recebido na data real — sem forçar tudo no mesmo dia ou parcela por parcela.', 'Novo'],
      ...
      <div class="col-md-4">
        <div class="price-card h-100 d-flex flex-column <?= !empty($p['destaque']) ? 'featured' : '' ?>">
          ...
          <div style="color:var(--muted);font-size:.8rem;margin-bottom:.6rem">
            <?= (int)$p['max_usuarios'] === 0 ? 'Usuários ilimitados' : ((int)$p['max_usuarios'] === 1 ? '1 usuário' : 'Até '.(int)$p['max_usuarios'].' usuários') ?> ·
      ...
      <div class="col-lg-7">
        ...
        $faqs=[
          ...
          ['Quantos usuários posso cadastrar?',
            'Depende do plano: o Básico inclui 1 usuário, o Autônomo 2, o Oficina 5, e no Top Empresa é ilimitado. Cada pessoa da equipe tem o próprio login — você faz upgrade a qualquer momento se precisar de mais gente.'],
