...
return [
    ...
    'planos' => [
        [
            ...
            'scan_placa_mes' => 10,
            'beneficios' => ['PDV / frente de caixa', 'Página pública no Diretório', '1 usuário', '30 OS por mês', 'Estoque de produtos ilimitado (sem foto)', 'Vitrine do Marketplace ilimitada, com foto', 'Sem cadastro automático por foto (preencha manualmente)', 'Sem Mentor IA', 'Crédito para +OS quando precisar'],
        ],
        [
            ...
            'beneficios' => ['Sistema completo de OS', '2 usuários', '60 OS por mês', 'Editar página no diretório', 'Estoque de produtos ilimitado (sem foto)', 'Vitrine do Marketplace ilimitada, com foto', 'Crédito para +OS quando precisar'],
        ],
        [
            ...
            'beneficios' => ['Tudo do Autônomo, mais:', '5 usuários', '150 OS por mês', 'WhatsApp pelo número próprio', 'Estoque de produtos ilimitado, com foto também no estoque', 'Destaque no diretório'],
        ],
        [
            ...
            'beneficios' => ['Tudo do Oficina, mais:', 'Usuários ilimitados', 'OS ilimitadas por mês', 'Estoque de produtos ilimitado, com foto também no estoque', 'Cadastro por foto e leitura de placa ilimitados', 'Destaque premium', 'Suporte prioritário'],
        ],
    ],
