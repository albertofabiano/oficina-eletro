...
return [
    ...
    'planos' => [
        ...
        [
            ...
            'beneficios' => ['Tudo do Autônomo, mais:', '10 usuários', '200 OS por mês', 'Foto no cadastro geral do estoque (não só no Marketplace/Diretório)', 'Destaque no diretório'],
        ],
        [
            ...
            'beneficios' => ['Tudo do Oficina, mais:', 'Usuários ilimitados', 'OS ilimitadas por mês', 'Cadastro por foto e leitura de placa ilimitados', 'Destaque premium no diretório', 'Suporte prioritário'],
        ],
    ],
